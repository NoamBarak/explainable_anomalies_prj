...
avg_distance = sum(distances) / len(distances)
print("Average Euclidean distance:", monte_carlo_counter_examples.get_euclidian_distance())
...
avg_distance = sum(distances) / len(distances)
print("Average Euclidean distance:", genetic_counter_examples.get_euclidian_distance())
...
avg_distance = sum(distances) / len(distances)
print("Average Euclidean distance:", mab_counter_examples.get_euclidian_distance())
